...
headers12	= {"Instance parameters": ["Name of instance", "Number of nodes", "Number of edges", "Number of partitions"], "Solver parameters":["Method","Peel", "Decompose", "Fold", "Curvature Type", "Curvature Method", "Clique Constraints"]}

headers1 	= ["Name", "Pre-processing Running time", "Running time", "Objective value"] 
