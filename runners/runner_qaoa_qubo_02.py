...
# name 				= "seed" + str(seed - 1) + "_rand_p" + str(graph_density) + "_neg" + str(neg_edge_percentage) + "_" + ("naive" if penalty_increase > 1 else "tight")
...
problem.Params.Method 					= "BQO" #R-QUBO BQO
